...
function init() {
    ...
    props.scene.push(new _plane2.default(props.width / 2, props.height / 2, props));
...
function draw() {
    ...
    for (var i = 0; i < props.scene.length; i++) {
...
var Victor = __webpack_require__(2);

var Plane = function () {
    function Plane(x, y, props) {
        var _this = this;
        ...
        document.body.addEventListener('keydown', function (e) {
            if (e.keyCode == 37) {
                _this.rotate(-_this.steeringAngle);
    ...
    _createClass(Plane, [{
        ...
        value: function update() {
            ...
            var x = this.velocity.x * Math.cos(angleRadians) - this.velocity.y * Math.sin(angleRadians);
            var y = this.velocity.y * Math.cos(angleRadians) - this.velocity.x * Math.sin(angleRadians);
